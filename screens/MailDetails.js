        ...
        <View style={styles.container}>
            <ScrollView>
                <View style={{ paddingVertical: 20, paddingHorizontal: 10, flexDirection: 'row', alignItems: 'center', justifyContent: "space-between", width: '100%' }}>
                    <Text style={{ width: '90%', fontSize: 22, fontWeight: 'bold' }}>California and texas hit grim new virus records, behind the WALL of MOMs protecting Portland and more from Apple news</Text>
                ...
                <View style={{ paddingHorizontal: 15, flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <View style={{ paddingHorizontal: 15, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        <Text style={{ paddingHorizontal: 5, fontSize: 18, fontWeight: 'bold' }}>Apple News</Text>
